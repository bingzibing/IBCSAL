...
def file_name(file_dir="D:/CB/deapProject/result/cnn_result/totalStatistic_result/"):
...
print("acc:", mean_acc, "recall:", mean_recall, "precision:", mean_precision, "f1_score:", mean_f1, "auc:",
      mean_auc,
      "save path: D:/CB/deapProject/result/cnn_result/totalStatistic_result/", save_file_name)
if save_file_name not in files:
    ...
    book.save("D:/CB/deapProject/result/cnn_result/totalStatistic_result/" + save_file_name)

rexcel = open_workbook(
    "D:/CB/deapProject/result/cnn_result/totalStatistic_result/" + save_file_name)  # 用wlrd提供的方法读取一个excel文件
...
excel.save("D:/CB/deapProject/result/cnn_result/totalStatistic_result/" + save_file_name)
